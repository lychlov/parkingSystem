...
<!--      </el-checkbox>-->
    ...
    >
      ...
      <el-table-column label="串号" width="180px" align="center">
        <template slot-scope="{row}">
...
<!--        </template>-->
<!--      </el-table-column>-->
      <el-table-column label="项目" width="180px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="串号" prop="serial_number">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.listLoading = true
      fetchCameraList(this.listQuery).then(response => {
