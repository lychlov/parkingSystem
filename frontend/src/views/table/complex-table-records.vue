<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="识别截图" width="150px" align="center">
        <template slot-scope="{row}">
          <span @click="handleShowImage(row)"><img :src="'data:image/png;base64,' + row.image_in_base64" style="width:100%"></span>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleShowImage(row) {
      ...
      this.image_url = 'data:image/png;base64,' + row.image_in_base64
    },
    handleUpdate(row) {
